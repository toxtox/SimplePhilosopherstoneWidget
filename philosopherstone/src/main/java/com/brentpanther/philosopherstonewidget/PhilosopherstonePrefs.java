...
class PhilosopherstonePrefs extends Prefs {

    PhilosopherstonePrefs(Context context, int widgetId) {
    ...
    public Exchange getExchange() {
        ...
        return PhilosopherstoneExchange.valueOf(value);
    }
    ...
    @Override
    public Unit getUnit() {
        return PhilosopherstoneUnit.PHS;
    }
